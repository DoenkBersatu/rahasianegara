...
define("EW_PROJECT_NAME", "dash", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{711D4B7A-499A-4AB9-B89B-D8472076C077}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'G9TjUcfIaUkjlQNF', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/dash.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "dpmptgar_dtinvestasi", "qs" => "`", "qe" => "`");
...
$EW_LANGUAGE_FILE[] = array("id", "", "ngapak.xml");
...
define("EW_ADMIN_PASSWORD", "adminkuh", TRUE); // Administrator password
...
define("EW_USER_ID_FILTER", "(`id_user` = %u)", TRUE);
