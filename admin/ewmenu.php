...
$RootMenu->AddMenuItem(17, "mi_jenis_perusahaan", $Language->MenuPhrase("17", "MenuText"), "jenis_perusahaanlist.php", -1, "", AllowListMenu('{711D4B7A-499A-4AB9-B89B-D8472076C077}jenis_perusahaan'), FALSE, FALSE);
$RootMenu->AddMenuItem(18, "mi_status", $Language->MenuPhrase("18", "MenuText"), "statuslist.php", -1, "", AllowListMenu('{711D4B7A-499A-4AB9-B89B-D8472076C077}status'), FALSE, FALSE);
