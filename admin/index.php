...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'realisasi_investasi'))
			$this->Page_Terminate("realisasi_investasilist.php");
		if ($Security->AllowList(CurrentProjectID() . 'sektor'))
			$this->Page_Terminate("sektorlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'subsektor'))
			$this->Page_Terminate("subsektorlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'triwulan'))
			$this->Page_Terminate("triwulanlist.php");
		...
		if ($Security->AllowList(CurrentProjectID() . 'form-upload.php'))
			$this->Page_Terminate("form-upload.php");
		if ($Security->AllowList(CurrentProjectID() . 'upload_aksi.php'))
