...
<div class="login-logo">
	<img src="<?php echo $EW_RELATIVE_PATH ?>phpimages/phpmkrlogo2017.png" alt="">
    <br />
...
$(".login-logo").html('');
$(".login-box-msg").prepend('<img class="card-img-top" src="phpimages/Logo_Garut_Jadi3.png" style="width:100px"alt="Card image cap"><br><br>');
</script>
