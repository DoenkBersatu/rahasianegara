...
$minat_investasi_edit = NULL; // Initialize page object first

class cminat_investasi_edit extends cminat_investasi {
	...
	// Page object name
	var $PageObjName = 'minat_investasi_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->id_minat_investasi->CurrentValue == "") {
			$this->Page_Terminate("minat_investasilist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// penanaman_modal
			$this->penanaman_modal->SetDbValueDef($rsnew, $this->penanaman_modal->CurrentValue, NULL, $this->penanaman_modal->ReadOnly);
...
// Create page object
if (!isset($minat_investasi_edit)) $minat_investasi_edit = new cminat_investasi_edit();

// Page init
$minat_investasi_edit->Page_Init();

// Page main
$minat_investasi_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$minat_investasi_edit->Page_Render();
?>
...
var CurrentForm = fminat_investasiedit = new ew_Form("fminat_investasiedit", "edit");

// Validate form
fminat_investasiedit.Validate = function() {
...
fminat_investasiedit.Form_CustomValidate = 
...
fminat_investasiedit.ValidateRequired = true;
<?php } else { ?>
fminat_investasiedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$minat_investasi_edit->IsModal) { ?>
<?php } ?>
<?php $minat_investasi_edit->ShowPageHeader(); ?>
<?php
$minat_investasi_edit->ShowMessage();
?>
<form name="fminat_investasiedit" id="fminat_investasiedit" class="<?php echo $minat_investasi_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($minat_investasi_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $minat_investasi_edit->Token ?>">
<?php } ?>
...
<?php if ($minat_investasi->id_minat_investasi->Visible) { // id_minat_investasi ?>
	<div id="r_id_minat_investasi" class="form-group">
		<label id="elh_minat_investasi_id_minat_investasi" class="col-sm-2 control-label ewLabel"><?php echo $minat_investasi->id_minat_investasi->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $minat_investasi->id_minat_investasi->CellAttributes() ?>>
<span id="el_minat_investasi_id_minat_investasi">
<span<?php echo $minat_investasi->id_minat_investasi->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $minat_investasi->id_minat_investasi->EditValue ?></p></span>
</span>
<input type="hidden" data-table="minat_investasi" data-field="x_id_minat_investasi" name="x_id_minat_investasi" id="x_id_minat_investasi" value="<?php echo ew_HtmlEncode($minat_investasi->id_minat_investasi->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $minat_investasi_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fminat_investasiedit.Init();
</script>
<?php
$minat_investasi_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$minat_investasi_edit->Page_Terminate();
?>
