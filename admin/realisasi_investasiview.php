...
$realisasi_investasi_view = NULL; // Initialize page object first

class crealisasi_investasi_view extends crealisasi_investasi {
	...
	// Page object name
	var $PageObjName = 'realisasi_investasi_view';
	...
	function __construct() {
		...
		if (@$_GET["id_realisasi_investasi"] <> "") {
			$this->RecKey["id_realisasi_investasi"] = $_GET["id_realisasi_investasi"];
			$KeyUrl .= "&amp;id_realisasi_investasi=" . urlencode($this->RecKey["id_realisasi_investasi"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id_realisasi_investasi"] <> "") {
				...
				$this->RecKey["id_realisasi_investasi"] = $this->id_realisasi_investasi->QueryStringValue;
			} elseif (@$_POST["id_realisasi_investasi"] <> "") {
				$this->id_realisasi_investasi->setFormValue($_POST["id_realisasi_investasi"]);
				$this->RecKey["id_realisasi_investasi"] = $this->id_realisasi_investasi->FormValue;
			} else {
				$sReturnUrl = "realisasi_investasilist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "realisasi_investasilist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "realisasi_investasilist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($realisasi_investasi_view)) $realisasi_investasi_view = new crealisasi_investasi_view();

// Page init
$realisasi_investasi_view->Page_Init();

// Page main
$realisasi_investasi_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$realisasi_investasi_view->Page_Render();
?>
...
var CurrentForm = frealisasi_investasiview = new ew_Form("frealisasi_investasiview", "view");

// Form_CustomValidate event
frealisasi_investasiview.Form_CustomValidate = 
...
frealisasi_investasiview.ValidateRequired = true;
<?php } else { ?>
frealisasi_investasiview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
frealisasi_investasiview.Lists["x_id_triwulan"] = {"LinkField":"x_ID_triwulan","Ajax":true,"AutoFill":false,"DisplayFields":["x_triwulan","x_tahun","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"triwulan"};
frealisasi_investasiview.Lists["x_id_sektor"] = {"LinkField":"x_id_sektor","Ajax":true,"AutoFill":false,"DisplayFields":["x_sektor","","",""],"ParentFields":[],"ChildFields":["x_id_subsektor"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sektor"};
frealisasi_investasiview.Lists["x_id_subsektor"] = {"LinkField":"x_id_subsektor","Ajax":true,"AutoFill":false,"DisplayFields":["x_subsektor","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"subsektor"};
...
<?php if (!$realisasi_investasi_view->IsModal) { ?>
<?php } ?>
<?php $realisasi_investasi_view->ExportOptions->Render("body") ?>
<?php
	foreach ($realisasi_investasi_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$realisasi_investasi_view->IsModal) { ?>
...
<?php $realisasi_investasi_view->ShowPageHeader(); ?>
<?php
$realisasi_investasi_view->ShowMessage();
?>
<form name="frealisasi_investasiview" id="frealisasi_investasiview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($realisasi_investasi_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $realisasi_investasi_view->Token ?>">
<?php } ?>
...
<?php if ($realisasi_investasi->id_realisasi_investasi->Visible) { // id_realisasi_investasi ?>
	<tr id="r_id_realisasi_investasi">
		<td><span id="elh_realisasi_investasi_id_realisasi_investasi"><?php echo $realisasi_investasi->id_realisasi_investasi->FldCaption() ?></span></td>
...
<?php echo $realisasi_investasi->id_realisasi_investasi->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($realisasi_investasi->id_triwulan->Visible) { // id_triwulan ?>
	<tr id="r_id_triwulan">
		<td><span id="elh_realisasi_investasi_id_triwulan"><?php echo $realisasi_investasi->id_triwulan->FldCaption() ?></span></td>
...
<?php echo $realisasi_investasi->id_triwulan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($realisasi_investasi->id_sektor->Visible) { // id_sektor ?>
	<tr id="r_id_sektor">
		<td><span id="elh_realisasi_investasi_id_sektor"><?php echo $realisasi_investasi->id_sektor->FldCaption() ?></span></td>
...
<?php echo $realisasi_investasi->id_sektor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($realisasi_investasi->id_subsektor->Visible) { // id_subsektor ?>
	<tr id="r_id_subsektor">
		<td><span id="elh_realisasi_investasi_id_subsektor"><?php echo $realisasi_investasi->id_subsektor->FldCaption() ?></span></td>
...
<?php echo $realisasi_investasi->id_subsektor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($realisasi_investasi->jumlah_investasi->Visible) { // jumlah_investasi ?>
	<tr id="r_jumlah_investasi">
		<td><span id="elh_realisasi_investasi_jumlah_investasi"><?php echo $realisasi_investasi->jumlah_investasi->FldCaption() ?></span></td>
...
<?php echo $realisasi_investasi->jumlah_investasi->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
frealisasi_investasiview.Init();
</script>
<?php
$realisasi_investasi_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$realisasi_investasi_view->Page_Terminate();
?>
