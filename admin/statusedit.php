...
class cstatus_edit extends cstatus {
	...
	function Page_Main() {
		...
		if (@$_GET["id_status"] <> "") {
			$this->id_status->setQueryStringValue($_GET["id_status"]);
		}
		...
		// Check if valid key
		if ($this->id_status->CurrentValue == "") {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->id_status->FldIsDetailKey)
			$this->id_status->setFormValue($objForm->GetValue("x_id_status"));
...
<?php if ($status->id_status->Visible) { // id_status ?>
	<div id="r_id_status" class="form-group">
		<label id="elh_status_id_status" class="col-sm-2 control-label ewLabel"><?php echo $status->id_status->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $status->id_status->CellAttributes() ?>>
<span id="el_status_id_status">
<span<?php echo $status->id_status->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $status->id_status->EditValue ?></p></span>
</span>
<input type="hidden" data-table="status" data-field="x_id_status" name="x_id_status" id="x_id_status" value="<?php echo ew_HtmlEncode($status->id_status->CurrentValue) ?>">
<?php echo $status->id_status->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($status->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_status_status" for="x_status" class="col-sm-2 control-label ewLabel"><?php echo $status->status->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $status->status->CellAttributes() ?>>
<span id="el_status_status">
<input type="text" data-table="status" data-field="x_status" name="x_status" id="x_status" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($status->status->getPlaceHolder()) ?>" value="<?php echo $status->status->EditValue ?>"<?php echo $status->status->EditAttributes() ?>>
</span>
