...
class cuser_list extends cuser {
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<label><input class=\"magic-checkbox ewPointer\" type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->id_user->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event);'><span></span></label>";
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == EW_ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"btn btn-xs btn-default line-2540\" title=\"" . ew_HtmlEncode($caption) . "\" data-caption=\"" . ew_HtmlEncode($caption) . "\" href=\"\" onclick=\"ew_SubmitAction(event,jQuery.extend({f:document.fuserlist}," . $listaction->ToJson(TRUE) . "));return false;\">" . $icon . "</a>";
...
fuserlist.Lists["x_userlevel"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
...
<form name="fuserlistsrch" id="fuserlistsrch" class="form-horizontal ewForm" action="<?php echo ew_CurrentPage() ?>">
<?php $SearchPanelClass = ($user_list->SearchWhere <> "") ? " in" : " in"; ?>
<div id="fuserlistsrch_SearchPanel" class="box box-default collapse<?php echo $SearchPanelClass ?>">
...
<?php } ?>
<input type="hidden" name="t" value="user">
<div id="gmp_user" class="table-responsive box box-primary ewGridMiddlePanel">
<?php if ($user_list->TotalRecs > 0 || $user->CurrentAction == "gridedit") { ?>
<table id="tbl_userlist" class="table ewTable table-bordered table-striped table-condensed table-hover">
...
<?php if ($user->id_user->Visible) { // id_user ?>
	...
	<?php } else { ?>
		<th data-name="id_user"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->id_user) ?>',1);"><div id="elh_user_id_user" class="user_id_user">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->id_user->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->id_user->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($user->id_user->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($user->username->Visible) { // username ?>
	...
	<?php } else { ?>
		<th data-name="username"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->username) ?>',1);"><div id="elh_user_username" class="user_username">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->username->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->username->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($user->username->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($user->password->Visible) { // password ?>
	...
	<?php } else { ?>
		<th data-name="password"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->password) ?>',1);"><div id="elh_user_password" class="user_password">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->password->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->password->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($user->password->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($user->_email->Visible) { // email ?>
	...
	<?php } else { ?>
		<th data-name="_email"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->_email) ?>',1);"><div id="elh_user__email" class="user__email">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->_email->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->_email->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($user->_email->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($user->userlevel->Visible) { // userlevel ?>
	...
	<?php } else { ?>
		<th data-name="userlevel"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->userlevel) ?>',1);"><div id="elh_user_userlevel" class="user_userlevel">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->userlevel->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->userlevel->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($user->userlevel->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<span id="el<?php echo $user_list->RowCnt ?>_user_userlevel" class="user_userlevel">
...
<!--first page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $user_list->PageUrl() ?>start=<?php echo $user_list->Pager->FirstButton->Start ?>"><span class="fa fa-fast-backward"></span></a>
	<?php } else { ?>
...
<!--previous page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $user_list->PageUrl() ?>start=<?php echo $user_list->Pager->PrevButton->Start ?>"><span class="fa fa-step-backward"></span></a>
	<?php } else { ?>
...
<!--next page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $user_list->PageUrl() ?>start=<?php echo $user_list->Pager->NextButton->Start ?>"><span class="fa fa-step-forward"></span></a>
	<?php } else { ?>
...
<!--last page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $user_list->PageUrl() ?>start=<?php echo $user_list->Pager->LastButton->Start ?>"><span class="fa fa-fast-forward"></span></a>
	<?php } else { ?>
