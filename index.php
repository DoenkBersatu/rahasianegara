...
<body>
    ...
    <?php 
    $datatw121 = $koneksi->query("select * from realisasi_investasi where id_triwulan = '5'");
    $tw121 = array();
    while($fetch121 = $datatw121->fetch_assoc()) {
        $tw121[] = $fetch121;
    }
    $datatw221 = $koneksi->query("select * from realisasi_investasi where id_triwulan = '6'");
    $tw221 = array();
    while($fetch221 = $datatw221->fetch_assoc()) {
        $tw221[] = $fetch221;
    }
    $datatw321 = $koneksi->query("select * from realisasi_investasi where id_triwulan = '7'");
    $tw321 = array();
    while($fetch321 = $datatw321->fetch_assoc()) {
        $tw321[] = $fetch321;
    }
    $datatw421 = $koneksi->query("select * from realisasi_investasi where id_triwulan = '8'");
    $tw421 = array();
  ...
  ?>
    ...
    <script>
    var tw121 = <?php echo json_encode($tw121['jumlah_investasi'], JSON_HEX_TAG); ?>;
    var tw221 = <?php echo json_encode($tw221['jumlah_investasi'], JSON_HEX_TAG); ?>;
    var tw321 = <?php echo json_encode($tw321['jumlah_investasi'], JSON_HEX_TAG); ?>;
    var tw421 = <?php echo json_encode($tw421['jumlah_investasi'], JSON_HEX_TAG); ?>;
    // charttw1
